...
- **需要登录**: 是；通过 `KH_PRESSURE_TEST_USERNAME` 和
  `KH_PRESSURE_TEST_PASSWORD` 配置
...
文件名：`pressure_output/submit_msg_results.csv`
